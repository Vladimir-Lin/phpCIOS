...
//////////////////////////////////////////////////////////////////////////////
public function GetAccessToken ( $DB , $TABLE                              ) {
  ////////////////////////////////////////////////////////////////////////////
  $UUID  = $this -> Uuid                                                     ;
  ////////////////////////////////////////////////////////////////////////////
  $QQ    = "select `name` , `value` from {$TABLE}"                           .
           " where ( `uuid` = {$UUID} )"                                     .
             " and ( `type` = 113 ) ;"                                       ;
  ////////////////////////////////////////////////////////////////////////////
  $qq    = $DB -> Query        ( $QQ                                       ) ;
  ...
  $LAK   = $NN                 [ "value"                                   ] ;
  ////////////////////////////////////////////////////////////////////////////
  $this -> Properties [ "LineUserId"  ] = $LUI                               ;
  $this -> Properties [ "AccessToken" ] = $LAK                               ;
  ////////////////////////////////////////////////////////////////////////////
}
//////////////////////////////////////////////////////////////////////////////
}
